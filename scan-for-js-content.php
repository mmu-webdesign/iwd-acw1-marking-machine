...
<head>
    <meta charset="UTF-8">
    <title>Scanning code: finding JS files or content</title>
...
$total_sites++;
      ...
      $test_for_js = strpos($page, '<script');
      if($test_for_js>0){
       echo "<p>Script tag <strong>FOUND</strong></p>";   
      }else{echo '<p style="font-weight:bold; color:red;">NO SCRIPT TAG FOUND</p>';}
      
      
      preg_match_all('#<script(.*?)</script>#is', $page, $matches);
      print_r($matches);
