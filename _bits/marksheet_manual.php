...
reporttask_automatic('Working hyperlink to http://www.cheese.com/',$score,2);
...
if($results['levelAAANormal']=='pass'){$score = 3;}
 ...
 $colour_start_link = $usefulcontent['.main-nav ul a:hover']['background-color'];

if (substr($colour_start_link,1)!=="#"){
...
$score =0;
 ...
 ?>
    ...
    <p><strong>Tutor&#8217;s comments</strong> <span class="js-comments"></span></p>
