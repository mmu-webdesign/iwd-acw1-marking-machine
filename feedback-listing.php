...
h2 {border-top:1px solid #ddd; padding: 0.5em 0 1em 0;}
    </style>
</head>
<body>
...
// worst to best ## Richard - removed most of errors as this is less about the code.
$metadata = Array (
    ...
    "Coherent and careful delivery of the required metadata. You have added relevant metadata but there are still some mistakes.",
...
// worst to best ## Richard - relates to template sub-40, removed validate from 50s.
$html_additions = Array (
...
// worst to best ## Richard not too much change her, again less specific.
$rwd_implementation = Array (
...
// worst to best ## Richard - amend these
$javascript = Array (
...
// worst to best ## Richard - less specific
$overall_technical_implementation = Array (
...
// worst to best ## Richard, again a few tweaks
$design_quality = Array (
...
// worst to best ## Richard
$writing_and_content = Array (
